...
class TaskManagerApplicationTests {
	 ...
	 public void getTasksTest() {
		 ...
		 when(repos.findAll()).thenReturn(Stream.of(new Tasks(1,"Jaiuu","Sample Debug",null),new Tasks(2,"GK","Frontend Debug",d1), new Tasks(3,"Janu","Backend Debug",d2)).collect(Collectors.toList()));
